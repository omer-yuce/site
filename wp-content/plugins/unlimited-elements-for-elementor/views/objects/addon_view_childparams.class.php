...
jQuery(document).ready(function(){
	...
	private function getChildParams_post_addTerms($arrParams){
		...
		$strCode .= "{# for get with custom fields write \"true\" in 3-th attribute: getPostTerms(item.post.id, \"post_tag\", true) #}\n\n";

		$strCode .= "{% set terms = getPostTerms(item.post.id, \"post_tag\", false) %}\n\n";
