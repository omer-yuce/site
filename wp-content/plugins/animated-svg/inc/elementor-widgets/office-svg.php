...
class Office_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Office Icons', 'animatesvg');
    }

    public function get_icon() {
        return 'fa fa-pen-nib';
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Office icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'office_book.svg',
				'options' => asvg_office_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Office_Svg() );