...
class Holiday_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Holiday - Events Icons ', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Holiday icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'christmas_bell.svg',
				'options' => asvg_holiday_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Holiday_Svg() );