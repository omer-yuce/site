...
class Weather_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Weather Icons', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Weather icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'basic_cloud.svg',
				'options' => asvg_weather_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Weather_Svg() );