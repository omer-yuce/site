...
class Medical_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Medical Icons', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Medical icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'medical_cross.svg',
				'options' => asvg_medical_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Medical_Svg() );