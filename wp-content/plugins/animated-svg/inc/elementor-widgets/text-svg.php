...
class Text_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Text & Numbers', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Text and numbers', 'animatesvg' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Text_Svg() );