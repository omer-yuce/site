...
class Objects_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Object Icons', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Object icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'object_anchor.svg',
				'options' => asvg_objects_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Objects_Svg() );