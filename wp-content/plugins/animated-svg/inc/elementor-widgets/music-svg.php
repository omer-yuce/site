...
class Music_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Music & Sound Icons ', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Music icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'music_button_beginning.svg',
				'options' => asvg_music_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Music_Svg() );