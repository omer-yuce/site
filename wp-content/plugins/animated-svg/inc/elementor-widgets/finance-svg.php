...
class Finance_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Financial Icons ', 'animatesvg');
    }

    public function get_icon() {
        return 'fa fa-comment-dollar';
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Finance icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'finance_chart_column.svg',
				'options' => asvg_finance_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Finance_Svg() );