...
class Retail_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Retail Icons ', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Retail icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'retail_badge_50_off.svg',
				'options' => asvg_retail_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Retail_Svg() );