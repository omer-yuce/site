...
class Food_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Food & Drink Icons ', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Food & drink library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'food_apple.svg',
				'options' => asvg_food_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Food_Svg() );