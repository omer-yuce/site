...
class Animated_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Basic Icons', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Basic icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'basic_alarm.svg',
				'options' => asvg_basic_icons_list(),
				'condition' => [
		...
		$this->add_responsive_control(
            ...
            [
				...
				'selectors' => [
					'{{WRAPPER}} .pt_plus_animated_svg .svg_inner_block' => 'width: {{SIZE}}{{UNIT}};height:{{SIZE}}{{UNIT}}',
				],
            ]
        );
		$this->add_control(
...
Plugin::instance()->widgets_manager->register_widget_type( new Animated_Svg() );