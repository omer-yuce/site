...
class Cta_SVG extends Widget_Base {
    ...
    public function get_title() {
        return __('Call To Action Icons', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Call to action icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'cta_click_button_left.svg',
				'options' => asvg_cta_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Cta_Svg() );