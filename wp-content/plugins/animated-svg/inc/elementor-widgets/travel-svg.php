...
class Travel_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Travel Icons ', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Travel icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'travel_airplane.svg',
				'options' => asvg_travel_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Travel_Svg() );