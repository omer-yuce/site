...
class Smiley_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Smiley & Emoticons ', 'animatesvg');
    }

    public function get_icon() {
        return 'fa fa-grin-squint-tears';
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Smiley icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'smiley_angel.svg',
				'options' => asvg_smiley_icons_list(),
				'condition' => [
        ...
        [
	  	...
	  	$this->add_control(
			'elements',
			[
				'label' => __( '<span style="font-size: 12px; font-style: normal; line-height: 1.4"><span style="font-size: 12px; font-style: normal;">Check out <a href="/wp-admin/admin.php?page=asvg_submenu" target="_blank"><span style="color: #f2295b;"><strong>Background Elements</strong></span></a> to create<br>unique & creative designs on your website.</span>' ),
				'separator' => 'before',	
...
Plugin::instance()->widgets_manager->register_widget_type( new Smiley_Svg() );