...
class Symbol_Svg extends Widget_Base {
    ...
    public function get_title() {
        return __('Symbols & Signs', 'animatesvg');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Symbol icon library', 'animatesvg' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'symbol_checkmark.svg',
				'options' => asvg_symbol_icons_list(),
				'condition' => [
...
Plugin::instance()->widgets_manager->register_widget_type( new Symbol_Svg() );