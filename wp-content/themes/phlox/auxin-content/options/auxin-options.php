   ...
   --------------------------------------------------------------------------------------------------- */
    ...
    $options[] = array(
        ...
        'style_callback' => function( $value = null ){
            ...
            return $value ? ".site-header-section.aux-sticky, .aux-elementor-header.aux-sticky .elementor-section-wrap > .elementor-section { background-color:$value; }" : '';
        },
        'type'      => 'color',
        'transport' => 'postMessage',
        'default'   => '#FFFFFF'
        ...
        'style_callback' => function( $value = null ){
            if( ! $value )
                ...
                $selector  = ".aux-top-sticky .site-header-section.aux-sticky .aux-fill .aux-menu-depth-0 > .aux-item-content, ".
                             ...
                             ".aux-elementor-header.aux-sticky .elementor-section-wrap > .elementor-section { height:%spx; }";
